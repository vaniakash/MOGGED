    ...
    <>
      ...
      >
        <div className="flex items-center justify-center mb-3">
          <img src="/logo-omogle.png" alt="Omogle" style={{ height: 100, objectFit: 'contain' }} />
        </div>
      ...
      >
        ...
        {/* Feature grid */}
        <div className="gap-3 mb-8" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 12 }}>
          {[
